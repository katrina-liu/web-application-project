...
urlpatterns = [
    ...
    path('edit_product/<int:id>', views.edit_product_action,
         name='edit_product'),
    path('delete_product/<int:id>', views.delete_product_action,
         name='delete_product'),
    ...
    path('remove_product_from_wishlist/<int:id>',
         views.remove_product_from_wishlist,
         name="remove_product_from_wishlist"),
    path('remove_product_from_cart/<int:id>', views.remove_product_from_cart,
         name="remove_product_from_cart"),
    path('clear_shopping_cart', views.clear_shopping_cart,
...
handler403 = 'ecommerce_platform.views.error_action'
handler400 = 'ecommerce_platform.views.error_action'
handler500 = 'ecommerce_platform.views.handler500'
